...
describe("BottomActionBar", () => {
  it("renders the primary CTA labelled 'Start a hunt'", () => {
    render(<BottomActionBar onStart={() => {}} onShuffle={() => {}} onCustom={() => {}} />);
  ...
  it("invokes onStart when the primary CTA is clicked", () => {
    ...
    render(<BottomActionBar onStart={onStart} onShuffle={() => {}} onCustom={() => {}} />);
  ...
  it("invokes onShuffle when the shuffle button is clicked", () => {
    ...
    render(<BottomActionBar onStart={() => {}} onShuffle={onShuffle} onCustom={() => {}} />);
  ...
  it("invokes onCustom when the custom-word button is clicked", () => {
    ...
    render(<BottomActionBar onStart={() => {}} onShuffle={() => {}} onCustom={onCustom} />);
